...
public class MenuTipoCliente extends AbstractMenu {
    ...
    public List<ElementoMenu> obtenerElementosMenu() {
        return Arrays.asList(
            ...
            new ElementoMenu(1, "Particular", new AccionMenuNavegar(new FormularioEditarCliente(new ClienteParticular(), true))),
            new ElementoMenu(2, "Empresa", new AccionMenuNavegar(new FormularioEditarCliente(new ClienteEmpresa(), true))),
