package com.arturobarba.poo.interfaz.pantallas.app.gestion.mueble.formularios;
...
public class FormularioEditarMueble extends AbstractFormulario {
    ...
    private void mostrarCamposComunes() {
        ...
        Salida.println(String.format("Precio (%s):", normalizarFloat(muebleEditado.getPrecio())));
