...
public class MenuTipoEmpleado extends AbstractMenu {
    ...
    public List<ElementoMenu> obtenerElementosMenu() {
        ...
        return Arrays.asList(
            ...
            new ElementoMenu(1, "Jefe", new AccionMenuNavegar(new FormularioEditarEmpleado(new Jefe(), true))),
            new ElementoMenu(2, "Comercial", new AccionMenuNavegar(new FormularioEditarEmpleado(new Comercial(), true))),
            new ElementoMenu(3, "Artesano Plantilla", new AccionMenuNavegar(new FormularioEditarEmpleado(new ArtesanoPlantilla(), true))),
            new ElementoMenu(4, "Artesano Horas", new AccionMenuNavegar(new FormularioEditarEmpleado(new ArtesanoHora(), true))),
